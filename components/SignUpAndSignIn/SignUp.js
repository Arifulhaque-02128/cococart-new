        ...
        <div className={styles.container}>
            <div>
                ...
                <form className={styles.loginForm} onSubmit={handleSubmit(onSubmit)}>
                    <TextField className={styles.textField} type="text" {...register("user_name", { required: true })} label="Name" />
                    {errors.user_name && <span className={styles.requiredMsg}>This field is required</span>} <br/> 
                    ...
                    {errors.password && <span className={styles.requiredMsg}>This field is required</span>} <br/> <br/>
